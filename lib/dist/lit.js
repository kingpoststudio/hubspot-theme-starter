...
const _t = (n) => new nt(typeof n == "string" ? n : n + "", void 0, W), St = (n, ...t) => {
 ...
 */
var k;
const O = window, J = O.trustedTypes, ft = J ? J.emptyScript : "", F = O.reactiveElementPolyfillSupport, D = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? ft : null;
      break;
  ...
  return e;
} }, ot = (n, t) => t !== n && (t == t || n == n), L = { attribute: !0, type: String, converter: D, reflect: !1, hasChanged: ot };
...
A.finalized = !0, A.elementProperties = /* @__PURE__ */ new Map(), A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, F == null || F({ ReactiveElement: A }), ((k = O.reactiveElementVersions) !== null && k !== void 0 ? k : O.reactiveElementVersions = []).push("1.6.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var j;
const T = window, m = T.trustedTypes, G = m ? m.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, M = "$lit$", v = `lit$${(Math.random() + "").slice(9)}$`, q = "?" + v, gt = `<${q}>`, y = document, C = () => y.createComment(""), w = (n) => n === null || typeof n != "object" && typeof n != "function", rt = Array.isArray, lt = (n) => rt(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Q = /-->/g, X = />/g, _ = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Y = /'/g, tt = /"/g, ht = /^(?:script|style|textarea|title)$/i, at = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), Ct = at(1), wt = at(2), E = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), et = /* @__PURE__ */ new WeakMap(), g = y.createTreeWalker(y, 129, null, !1), dt = (n, t) => {
  ...
  for (let l = 0; l < e; l++) {
    ...
    for (; p < h.length && (o.lastIndex = p, a = o.exec(h), a !== null); )
      p = o.lastIndex, o === b ? a[1] === "!--" ? o = Q : a[1] !== void 0 ? o = X : a[2] !== void 0 ? (ht.test(a[2]) && (i = RegExp("</" + a[2], "g")), o = _) : a[3] !== void 0 && (o = _) : o === _ ? a[0] === ">" ? (o = i ?? b, c = -1) : a[1] === void 0 ? c = -2 : (c = o.lastIndex - a[2].length, $ = a[1], o = a[3] === void 0 ? _ : a[3] === '"' ? tt : Y) : o === tt || o === Y ? o = _ : o === Q || o === X ? o = b : (o = _, i = void 0);
    const P = o === _ && n[l + 1].startsWith("/>") ? " " : "";
    r += o === b ? h + gt : c >= 0 ? (s.push($), h.slice(0, c) + M + h.slice(c) + v + P) : h + v + (c === -2 ? (s.push(void 0), l) : P);
  }
...
class x {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const d = t.length - 1, l = this.parts, [h, $] = dt(t, e);
    if (this.el = x.createElement(h, s), g.currentNode = this.el.content, e === 2) {
      const a = this.el.content, c = a.firstChild;
      c.remove(), a.append(...c.childNodes);
    }
    for (; (i = g.nextNode()) !== null && l.length < d; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) {
          const a = [];
          for (const c of i.getAttributeNames())
            if (c.endsWith(M) || c.startsWith(v)) {
              const p = $[o++];
              if (a.push(c), p !== void 0) {
                const P = i.getAttribute(p.toLowerCase() + M).split(v), H = /([.?@])?(.*)/.exec(p);
                l.push({ type: 1, index: r, name: H[2], strings: P, ctor: H[1] === "." ? ut : H[1] === "?" ? pt : H[1] === "@" ? $t : U });
              } else
        ...
        if (ht.test(i.tagName)) {
          ...
          if (c > 0) {
            ...
            for (let p = 0; p < c; p++)
              i.append(a[p], C()), g.nextNode(), l.push({ type: 2, index: ++r });
            i.append(a[c], C());
          }
        }
...
function f(n, t, e = n, s) {
  var i, r, o, d;
  if (t === E)
    return t;
  let l = s !== void 0 ? (i = e._$Co) === null || i === void 0 ? void 0 : i[s] : e._$Cl;
  const h = w(t) ? void 0 : t._$litDirective$;
  return (l == null ? void 0 : l.constructor) !== h && ((r = l == null ? void 0 : l._$AO) === null || r === void 0 || r.call(l, !1), h === void 0 ? l = void 0 : (l = new h(n), l._$AT(n, e, s)), s !== void 0 ? ((o = (d = e)._$Co) !== null && o !== void 0 ? o : d._$Co = [])[s] = l : e._$Cl = l), l !== void 0 && (t = f(n, l._$AS(n, t.values), l, s)), t;
}
class ct {
  constructor(t, e) {
  ...
  u(t) {
    ...
    g.currentNode = r;
    let o = g.nextNode(), d = 0, l = 0, h = i[0];
    for (; h !== void 0; ) {
      if (d === h.index) {
        let $;
        h.type === 2 ? $ = new S(o, o.nextSibling, this, t) : h.type === 1 ? $ = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && ($ = new vt(o, this, t)), this._$AV.push($), h = i[++l];
      }
...
class S {
  ...
  _$AI(t, e = this) {
    t = f(this, t, e), w(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : lt(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== u && w(this._$AH) ? this._$AA.nextSibling.data = t : this.$(y.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    ...
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === r)
      ...
      const o = new ct(r, this), d = o.u(this.options);
  ...
  T(t) {
    ...
    let s, i = 0;
    for (const r of t)
      i === e.length ? e.push(s = new S(this.k(C()), this.k(C()), this, this.options)) : s = e[i], s._$AI(r), i++;
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (r === void 0)
      ...
      for (t = r[0], l = 0; l < r.length - 1; l++)
        h = f(this, d[s + l], e, l), h === E && (h = this._$AH[l]), o || (o = !w(h) || h !== this._$AH[l]), h === u ? t = u : t !== u && (t += (h ?? "") + r[l + 1]), this._$AH[l] = h;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
class $t extends U {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = f(this, t, e, 0)) !== null && s !== void 0 ? s : u) === E)
      return;
...
const xt = { O: M, P: v, A: q, C: 1, M: dt, L: ct, D: lt, R: f, I: S, V: U, H: pt, N: $t, U: ut, F: vt }, st = T.litHtmlPolyfillSupport;
st == null || st(x, S), ((j = T.litHtmlVersions) !== null && j !== void 0 ? j : T.litHtmlVersions = []).push("2.7.2");
const yt = (n, t, e) => {
  var s, i;
...
R.finalized = !0, R._$litElement$ = !0, (B = globalThis.litElementHydrateSupport) === null || B === void 0 || B.call(globalThis, { LitElement: R });
const it = globalThis.litElementPolyfillSupport;
it == null || it({ LitElement: R });
const Pt = { _$AK: (n, t, e) => {
  n._$AK(t, e);
}, _$AL: (n) => n._$AL };
((I = globalThis.litElementVersions) !== null && I !== void 0 ? I : globalThis.litElementVersions = []).push("3.3.1");
/**
 * @license
